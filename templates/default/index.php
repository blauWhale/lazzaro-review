<main class="main">
    ...
    <div class="main-content">
        <div class="container">
            <div class="row">
                <div class="col-md-9" id="page-title">
                    <h4>Reviews</h4>
                </div>
                <div class="col-md-3">
            ...
            <div class="row">
                <div id="cardspace" class="col-md-9 container">
                ...
                <div class="col-md-3">
                    <div class="list-group">
                        ...
                        foreach ($genres as $genre):
                            ?>
                            <a href="/?<?= $oldFilters ?>searchGenre=<?= $genre ?>"
                               class="list-group-item list-group-item-action" name="genreFilter">
                                <?= $genre ?>
                            </a>
                            <?php ?>
                        <?php endforeach; ?>
                        ...
                        foreach ($years as $year): ?>
                            <a href="/?<?= $oldFilters ?>searchYear=<?= $year ?>"
                               class="list-group-item list-group-item-action" name="yearFilter">
                                <?= $year ?>
                            </a>
                        <?php endforeach; ?>
                    </div>
